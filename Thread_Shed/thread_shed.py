...
for split in daily_transaction:
  daily_transactions_split.append(split.split('+'))
...
for daily in daily_transactions_split:
  ...
  for each in daily:
    ...
    transaction_clean.append(each.replace('\n',' ').strip(" "))
    transactions_clean.append(transaction_clean)
  #transactions_clean.append(each.strip( ))
...
for cu in transactions_clean:
  #print (cu)
  customers.append(cu[0])
  sales.append(cu[1])
  thread_sold.append(cu[2])
